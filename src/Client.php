...
use Exception;
use Omisteck\Peek\Exceptions\StopExecutionRequested;
use Omisteck\Peek\Origin\Hostname;
...
class Client
{
    ...
    protected function getCurlHandle(string $method, string $fullUrl)
    {
        ...
        curl_setopt($this->curlHandle, CURLOPT_USERAGENT, 'Peek 1.0');
