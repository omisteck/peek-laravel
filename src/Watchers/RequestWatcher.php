...
class RequestWatcher extends Watcher
{
    public function register(): void
    {
        ...
        $this->enabled = $settings->send_requests_to_peek;
        ...
        Event::listen(RequestHandled::class, function (RequestHandled $event) {
            ...
            $peek = $this->handleRequest($event->request, $event->response);

            optional($this->peekProxy)->applyCalledMethods($peek);
        });
    }

    protected function handleRequest(Request $request, Response $response): BasePeek
    {
